...
export function generateGetOperation({ entity, entities, schemaNamespace }) {
    ...
    let params = isTopLevelArray ? '(id: $id, version: $version, readMode: $readMode)' : '(version: $version, readMode: $readMode)';
    let paramTypes = isTopLevelArray ? '($id: ID!, $version: Int, $readMode: Vendia_ReadMode = NODE_COMMITTED)' : '($version: Int, $readMode: Vendia_ReadMode = NODE_COMMITTED)';
