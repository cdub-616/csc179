...
async function main() {
  ...
  try {
    ...
    if (process.cwd().endsWith('src/packages/vendia-client')) {
      ...
      console.log('Skipping post-install for Vendia monorepo installation...')
      
      // TODO: skipping codegen for vendia monorepo installation, not necessary but keeping code for now
