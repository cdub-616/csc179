...
var _uniInfo__getDocument = import_graphql_tag.default`
  ...
  getVendia_UniInfo {
    ...
    `;
var ShoppingList__getDocument = import_graphql_tag.default`
  ...
  get_ShoppingList(id: $id, version: $version, readMode: $readMode) {
    ...
    ... on Self_ShoppingList_Partial_ {
      _id
      _owner
      __alias__item: item
      __alias__quantity: quantity
      __alias__recommendedLocation: recommendedLocation
      __alias__bought: bought
      __alias__timestampAdded: timestampAdded
      __alias__timestampPurchased: timestampPurchased
    }
  }
}
    `;
var ShoppingList__listDocument = import_graphql_tag.default`
  ...
  list_ShoppingListItems(
    ...
    `;
var ShoppingList__addDocument = import_graphql_tag.default`
  ...
  add_ShoppingList(input: $input, syncMode: $syncMode, aclInput: $aclInput) {
    ...
    `;
var ShoppingList__updateDocument = import_graphql_tag.default`
  ...
  update_ShoppingList(
    ...
    `;
var ShoppingList__removeDocument = import_graphql_tag.default`
  ...
  remove_ShoppingList(id: $id, syncMode: $syncMode, condition: $condition) {
    ...
    `;
var ShoppingList__onAddDocument = import_graphql_tag.default`
  ...
  onAdd_ShoppingList {
    ...
    `;
var ShoppingList__onRemoveDocument = import_graphql_tag.default`
  ...
  onRemove_ShoppingList {
    ...
    `;
var ShoppingList__onUpdateDocument = import_graphql_tag.default`
    ...
    shoppingList: {
      get(id, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(ShoppingList__getDocument, variables, wrappedRequestHeaders).then((res) => res.get_ShoppingList).then((res) => {
      ...
      list(options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(ShoppingList__listDocument, variables, wrappedRequestHeaders).then((res) => {
            var _a;
            const updatedRes = { ...res.list_ShoppingListItems, items: (_a = res.list_ShoppingListItems) == null ? void 0 : _a._ShoppingListItems };
            delete updatedRes._ShoppingListItems;
            return updatedRes;
          }).then((res) => {
      ...
      add(input, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(ShoppingList__addDocument, variables, wrappedRequestHeaders).then((res) => res.add_ShoppingList).then((res) => {
      ...
      update(input, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(ShoppingList__updateDocument, variables, wrappedRequestHeaders).then((res) => res.update_ShoppingList).then((res) => {
            const result = stripAliasPrefixesFromKeys(res == null ? void 0 : res.result);
            return { ...res, result };
          });
        }, "update_ShoppingList");
      ...
      remove(id, options) {
        const variables = { ...options, id };
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(ShoppingList__removeDocument, variables, wrappedRequestHeaders).then((res) => res.remove_ShoppingList);
        }, "remove_ShoppingList");
      },
      onAdd(handler) {
        return _subscribe({ query: ShoppingList__onAddDocument }, ({ data }) => {
          return handler(data.onAdd_ShoppingList);
        });
      },
      onRemove(handler) {
        return _subscribe({ query: ShoppingList__onRemoveDocument }, ({ data }) => {
          return handler(data.onRemove_ShoppingList);
        });
      },
      onUpdate(handler) {
        return _subscribe({ query: ShoppingList__onUpdateDocument }, ({ data }) => {
          return handler(data.onUpdate_ShoppingList);
        });
      }
    }
  };
