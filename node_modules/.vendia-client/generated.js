...
exports._uniInfo__getDocument = (0, graphql_tag_1.default) `
  ...
  getVendia_UniInfo {
    ...
    `;
exports.ShoppingList__getDocument = (0, graphql_tag_1.default) `
    query ShoppingList__get($id: ID!, $version: Int, $readMode: Vendia_ReadMode = NODE_COMMITTED) {
  get_ShoppingList(id: $id, version: $version, readMode: $readMode) {
    ... on Self_ShoppingList {
      _id
      _owner
      item
      quantity
    ...
    `;
exports.ShoppingList__listDocument = (0, graphql_tag_1.default) `
    query ShoppingList__list($nextToken: String, $limit: Int, $filter: Self_ShoppingList_FilterInput_, $order: [Self_ShoppingList_OrderInput_!], $readMode: Vendia_ReadMode = NODE_COMMITTED) {
  list_ShoppingListItems(
    ...
    `;
exports.ShoppingList__addDocument = (0, graphql_tag_1.default) `
    mutation ShoppingList__add($input: Self_ShoppingList_Input_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $aclInput: Vendia_Acls_Input_) {
  add_ShoppingList(input: $input, syncMode: $syncMode, aclInput: $aclInput) {
    transaction {
      _id
      _owner
      transactionId
    ...
    `;
exports.ShoppingList__updateDocument = (0, graphql_tag_1.default) `
    mutation ShoppingList__update($id: ID!, $input: Self_ShoppingList_UpdateInput_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_ShoppingList_ConditionInput_, $aclInput: Vendia_Acls_Input_) {
  update_ShoppingList(
    id: $id
    input: $input
    syncMode: $syncMode
    ...
    `;
exports.ShoppingList__removeDocument = (0, graphql_tag_1.default) `
    mutation ShoppingList__remove($id: ID!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_ShoppingList_ConditionInput_) {
  remove_ShoppingList(id: $id, syncMode: $syncMode, condition: $condition) {
    transaction {
      _id
      _owner
      transactionId
    ...
    `;
exports.ShoppingList__onAddDocument = (0, graphql_tag_1.default) `
    subscription ShoppingList__onAdd {
  onAdd_ShoppingList {
    error
    result {
      _id
    ...
    `;
exports.ShoppingList__onRemoveDocument = (0, graphql_tag_1.default) `
    subscription ShoppingList__onRemove {
  onRemove_ShoppingList {
    ...
    `;
exports.ShoppingList__onUpdateDocument = (0, graphql_tag_1.default) `
    subscription ShoppingList__onUpdate {
        ...
        shoppingList: {
            get(id, options) {
                ...
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.ShoppingList__getDocument, variables, wrappedRequestHeaders)
                        .then(res => res.get_ShoppingList);
                }, 'get_ShoppingList');
            },
            list(options) {
                const variables = options;
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.ShoppingList__listDocument, variables, wrappedRequestHeaders)
                        .then(res => { const updatedRes = { ...res.list_ShoppingListItems, items: res.list_ShoppingListItems?._ShoppingListItems }; delete updatedRes._ShoppingListItems; return updatedRes; });
                }, 'list_ShoppingListItems');
            },
            add(input, options) {
                const variables = { ...options, input };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.ShoppingList__addDocument, variables, wrappedRequestHeaders)
                        .then(res => res.add_ShoppingList);
                }, 'add_ShoppingList');
            },
            update(input, options) {
                ...
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.ShoppingList__updateDocument, variables, wrappedRequestHeaders)
                        .then(res => res.update_ShoppingList);
                }, 'update_ShoppingList');
            },
            remove(id, options) {
                const variables = { ...options, id };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.ShoppingList__removeDocument, variables, wrappedRequestHeaders)
                        .then(res => res.remove_ShoppingList);
                }, 'remove_ShoppingList');
            },
            onAdd(handler) {
                return _subscribe({ query: exports.ShoppingList__onAddDocument }, ({ data }) => { return handler(data.onAdd_ShoppingList); });
            },
            onRemove(handler) {
                return _subscribe({ query: exports.ShoppingList__onRemoveDocument }, ({ data }) => { return handler(data.onRemove_ShoppingList); });
            },
            onUpdate(handler) {
                return _subscribe({ query: exports.ShoppingList__onUpdateDocument }, ({ data }) => { return handler(data.onUpdate_ShoppingList); });
            }
        }
    };
}
