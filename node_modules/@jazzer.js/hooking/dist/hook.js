...
exports.Hook = exports.HookType = exports.hookTracker = exports.logHooks = void 0;
...
function logHooks(hooks) {
    hooks.forEach((hook) => {
        if (process.env.JAZZER_DEBUG) {
            console.log(`DEBUG: Applied %s-hook in %s#%s`, HookType[hook.type], hook.pkg, hook.target);
        }
    });
}
