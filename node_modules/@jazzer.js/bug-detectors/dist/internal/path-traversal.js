    ...
    for (const functionName of module.functionNames) {
        const beforeHook = (thisPtr, params, hookId) => {
            ...
            if (firstArgument.includes(goal)) {
                (0, findings_1.reportFinding)(`Path Traversal in ${functionName}(): called with '${firstArgument}'`);
            }
            (0, fuzzer_1.guideTowardsContainment)(firstArgument, goal, hookId);
        };
    ...
    for (const functionName of module.functionNames) {
        const makeBeforeHook = (extraHookId) => {
            return (thisPtr, params, hookId) => {
                ...
                (0, fuzzer_1.guideTowardsContainment)(secondArgument, goal, extraHookId);
            };
        };
