...
exports.FuzzedDataProvider = void 0;
/**
...
class FuzzedDataProvider {
    ...
    consumeString(maxLength, encoding = "ascii") {
        ...
        const result = this.data.toString(encoding, this.dataPtr, this.dataPtr + arrayLength);
        this.dataPtr += arrayLength;
        this._remainingBytes -= arrayLength;
        return result;
    }
     ...
     */
    consumeRemainingAsString(encoding = "ascii") {
     ...
     */
    consumeStringArray(maxArrayLength, maxStringLength, encoding = "ascii") {
        const strs = [];
