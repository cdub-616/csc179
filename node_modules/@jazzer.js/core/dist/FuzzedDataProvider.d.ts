...
export declare class FuzzedDataProvider {
     ...
     */
    consumeString(maxLength: number, encoding?: BufferEncoding | undefined): string;
    /**
     ...
     */
    consumeRemainingAsString(encoding?: BufferEncoding | undefined): string;
    /**
     ...
     */
    consumeStringArray(maxArrayLength: number, maxStringLength: number, encoding?: BufferEncoding | undefined): string[];
    /**
     ...
     * @returns an integral
     */
    consumeBigIntegralLEorBE(maxNumBytes: number, isSigned?: boolean, isLittleEndian?: boolean): bigint;
    /**
     * Consumes several bytes from fuzzer data and converts them to a bigint that is
     * in the range of [min, max]. The number of bytes consumed is determined by
     * the size of the range. If there is no input data left, the returned number
