...
function guideTowardsEquality(current, target, id) {
    fuzzer_1.fuzzer.tracer.traceUnequalStrings(id, current, target);
}
/**
...
function guideTowardsContainment(needle, haystack, id) {
    fuzzer_1.fuzzer.tracer.traceStringContainment(id, needle, haystack);
}
/**
...
function exploreState(state, id) {
    fuzzer_1.fuzzer.tracer.tracePcIndir(id, state);
}
exports.jazzer = {
...
//# sourceMappingURL=jazzer.js.map