...
exports.registerInstrumentor = exports.Instrumentor = exports.MemorySyncIdStrategy = exports.FileSyncIdStrategy = void 0;
...
class Instrumentor {
    ...
    instrument(code, filename) {
        ...
        if (shouldInstrumentFile) {
            transformations.push((0, codeCoverage_1.codeCoverage)(this.idStrategy), compareHooks_1.compareHooks);
        }
    ...
    unloadInternalModules() {
        console.log("DEBUG: Unloading internal Jazzer.js modules for instrumentation...");
        [
