...
exports.exploreState = exports.guideTowardsContainment = exports.guideTowardsEquality = exports.fuzzer = void 0;
...
exports.fuzzer = {
    ...
    stopFuzzingAsync: addon_1.addon.stopFuzzingAsync,
    stopFuzzing: addon_1.addon.stopFuzzing,
};
/**
...
function guideTowardsEquality(current, target, id) {
    trace_1.tracer.traceUnequalStrings(id, current, target);
}
exports.guideTowardsEquality = guideTowardsEquality;
/**
...
function guideTowardsContainment(needle, haystack, id) {
    trace_1.tracer.traceStringContainment(id, needle, haystack);
}
exports.guideTowardsContainment = guideTowardsContainment;
/**
...
function exploreState(state, id) {
    trace_1.tracer.tracePcIndir(id, state);
}
